...
> Answer: The benefits of using client-side routing allows the client to download all of the content 
for the site for quick reloading between various nav items, components, etc. and does not require 
